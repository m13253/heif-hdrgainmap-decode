...
def main(argv: typing.List[str]) -> None:
    ...
    output_spec.attribute('ICCProfile', 'uint8[1132]', np.asarray(bytearray(base64.b64decode(
        # ACES-elle-V2-g10.icc from https://github.com/ellelstone/elles_icc_profiles
        # Licensed under CC-BY-SA 3.0.
        'AAAEbGxjbXMCIAAAbW50clJHQiBYWVogB+AABAAWABUADQAiYWNzcCpuaXgAAAAAAAAAAA'
        ...
        'AgQAAAAOZ1RSQwAAAhQAAAAOYlRSQwAAAiQAAAAOZG1uZAAAAjQAAAGUZGVzYwAAA8gAAA'
        ...
        'AAAAAAAA8+EAAQAAAAECQlhZWiAAAAAAAAAAAAAAAAAAAAAAWFlaIAAAAAAAAP2rAABcpf'
        '///05YWVogAAAAAAAAAyIAALj3AAACHVhZWiAAAAAA///2Cf//6mQAANHCY3VydgAAAAAA'
        'AAABAQAAAGN1cnYAAAAAAAAAAQEAAABjdXJ2AAAAAAAAAAEBAAAAZGVzYwAAAAAAAABoQU'
        'NFUyBjaHJvbWF0aWNpdGllcyBmcm9tIFRCLTIwMTQtMDA0LCBodHRwOi8vd3d3Lm9zY2Fy'
        'cy5vcmcvc2NpZW5jZS10ZWNobm9sb2d5L2FjZXMvYWNlcy1kb2N1bWVudGF0aW9uAAAAAA'
        'AAAAAAaQBBAEMARQBTACAAYwBoAHIAbwBtAGEAdABpAGMAaQB0AGkAZQBzACAAZgByAG8A'
        'bQAgAFQAQgAtADIAMAAxADQALQAwADAANAAsACAAaAB0AHQAcAA6AC8ALwB3AHcAdwAuAG'
        '8AcwBjAGEAcgBzAC4AbwByAGcALwBzAGMAaQBlAG4AYwBlAC0AdABlAGMAaABuAG8AbABv'
        'AGcAeQAvAGEAYwBlAHMALwBhAGMAZQBzAC0AZABvAGMAdQBtAGUAbgB0AGEAdABpAG8Abg'
        'AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA'
        'AAAAAAAAAAAAAAAAAAAAAAAAAAAAAABkZXNjAAAAAAAAABhBQ0VTLWVsbGUtVjItZzEwLm'
        'ljYwAAAAAAAAAAAAAAGQBBAEMARQBTAC0AZQBsAGwAZQAtAFYAMgAtAGcAMQAwAC4AaQBj'
        'AGMAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA'
